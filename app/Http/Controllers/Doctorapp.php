...
use App\Usertag;
use App\Countries;
class Doctorapp extends Controller
{
    //
    ...
    {
      $users = Myusers::where('type','DOCTOR')->where('approved','0')->orderBy('id', 'DESC')->paginate(15);
      return view('doctorapprove',['users'=>$users]);//print_R($flights);
    }
