...
<div class="tabledit-toolbar btn-toolbar" style="text-align: left;">
   <div class="btn-group btn-group-sm" style="float: none;"><a type="button" class="tabledit-edit-button btn btn-sm btn-default" style="float: none;" href="{{route('editDoctor', ['id' => $user->id])}}"><span class="glyphicon glyphicon-pencil"></span></a><a href="{{route('deletedoctor', ['id' => $user->id])}}" type="button" class="tabledit-delete-button btn btn-sm btn-default" style="float: none;"><span class="glyphicon glyphicon-trash"></span></a
   ></div>
...
<div class="tabledit-toolbar btn-toolbar" style="text-align: left;">
   ...
   @if($user->approved==0)
   <a type="button" class="tabledit-edit-button btn btn-sm btn-default" style="float: none;" href="{{route('approve', ['id' => $user->id])}}">Approve</a>
   @else
      <a type="button" class="tabledit-edit-button btn btn-sm btn-success" style="float: none;" href="javascript:void(0)">Approved</a>
   @endif
